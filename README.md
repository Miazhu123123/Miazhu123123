...
I am a Master of Computer Science student at the University of Auckland with interests in full-stack software development, interactive systems, and Generative AI. My background combines web application development, backend systems, and hands-on experience with VR-based interactive applications.

---

## Research

My current postgraduate research focuses on efficiency aspects of Generative AI systems.
...
## Planned Independent Project

### Fitness and Dietary Control Application

- Planning to independently design and develop a web application focused on fitness tracking and dietary control.
- The goal is to further strengthen full-stack development skills, system design ability, and product-oriented thinking through an end-to-end personal project.
...
**Backend:** Node.js, RESTful APIs, FastAPI (learning)  
**Databases:** MongoDB, SQL  
**Interactive & VR:** Unity, C#, VR interaction systems  
**Tools & Platforms:** Git, Vercel, Supabase (basic)
